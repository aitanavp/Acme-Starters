...
public class ProjectMemberProjectController extends AbstractController<ProjectMember, Project> {
	...
	protected void initialise() {
		...
		super.addCustomCommand("add-members", "show", ProjectMemberProjectMembersAddService.class);
		super.addCustomCommand("delete-members", "show", ProjectMemberProjectMembersDeleteService.class);
