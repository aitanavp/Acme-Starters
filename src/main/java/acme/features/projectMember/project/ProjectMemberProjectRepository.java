...
public interface ProjectMemberProjectRepository extends AbstractRepository {
	...
	@Query("select pm.project from ProjectMembership pm where pm.projectMember.id = :projectMemberId")
	Collection<Project> findProjectsByProjectMemberId(int projectMemberId);
